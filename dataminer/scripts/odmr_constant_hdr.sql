...
AUTHID CURRENT_USER AS
  ...
  */
  ...
  -- activity state
  WORKFLOW_STATUS_ACTIVE        CONSTANT VARCHAR2(30) := 'ACTIVE';      -- Activity is being executed or scheduled to run
  WORKFLOW_STATUS_INACTIVE      CONSTANT VARCHAR2(30) := 'INACTIVE';    -- Activity is idle
  WORKFLOW_STATUS_STOPPED       CONSTANT VARCHAR2(30) := 'STOPPED';     -- Activity is stopped
  WORKFLOW_STATUS_QUEUED        CONSTANT VARCHAR2(30) := 'QUEUED';      -- Activity is queued (waiting to be run)
