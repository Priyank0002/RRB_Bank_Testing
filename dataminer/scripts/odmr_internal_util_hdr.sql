...
AUTHID CURRENT_USER AS
  ...
  --PROCEDURE create_cache_view(p_table_name IN VARCHAR2, p_input_data IN VARCHAR2);
  ...
  PROCEDURE clean_table_or_view_if_present( p_object_name  VARCHAR2 );
 ...
 PROCEDURE ls_replace(
  ...
  PROCEDURE drop_table_ignore_exception (table_name IN VARCHAR2);

  PROCEDURE drop_view_ignore_exception (view_name IN VARCHAR2);
  ...
  --FUNCTION model_exists(p_model IN VARCHAR2) RETURN BOOLEAN;
  ...
  TYPE MSG_PARAMS  is TABLE OF VARCHAR2(4000);
