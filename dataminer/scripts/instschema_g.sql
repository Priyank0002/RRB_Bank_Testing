...
<!--  <xs:complexType xdb:maintainDOM="false">
 ...
 <xs:complexType name="AggregationElementType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <!--Agg.Node start-->
 <xs:complexType xdb:maintainDOM="false" name="AggregationNodeType">
  <xs:complexContent>
 ...
 <!--Agg.Node end-->
 <xs:complexType name="AnomalyDetectionBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ApplyOutputColumnsType" xdb:maintainDOM="false">
  <xs:sequence>
...
schema2 := '/>
 ...
 <xs:complexType name="ApplyNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="AprioriModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ModelType">
    <xs:sequence>
 ...
 <xs:complexType name="AssociationBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="BuildNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="AttributeType" xdb:maintainDOM="false">
  <xs:attribute name="Name" use="required">
   <xs:simpleType>
    <xs:restriction base="xs:string">
     <xs:minLength value="1"/>
 ...
 <xs:complexType name="AttrImportantSettingsType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="BuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
...
<xs:complexType name="BuildTextNodeRefType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="BuildTextNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TextNodeType">
    <xs:sequence>
 ...
 -->
 <xs:complexType name="CGeneralizedLinearAlgoType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="GeneralizedLinearAlgoType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="CGeneralizedLinearModelType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ClassificationBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ClassificationModelType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ClassificationResultType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ClassificationTestSettingsType" xdb:maintainDOM="false">
  <xs:choice>
 ...
 <xs:complexType name="ClusteringBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="BuildNodeType">
    <xs:sequence>
     <xs:element name="Models">
 ...
 <xs:complexType name="ClusterIdType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="ClusterProbabilityType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="ClusterSetType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="DataQualitySettingsType" xdb:maintainDOM="false">
 ...
 <xs:complexType name="ColumnFilterSettingsType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="ColumnFilterAttributeType" xdb:maintainDOM="false">
 ...
 <xs:complexType name="ColumnFilterNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="CostMatrixType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="CreateTableNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="CSupportVectorMachineAlgoType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="SupportVectorMachineAlgoType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="CSupportVectorMachineModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ClassificationModelType">
    <xs:sequence>
 ...
 <xs:complexType name="DataNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="DataProfileNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="DataProfileInputType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="Attributes"/>
   <xs:element name="GroupByAttribute" type="AttributeType" minOccurs="0"/>
  </xs:sequence>
 </xs:complexType>
 <xs:complexType name="DataProfileOutputType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="Attributes"/>
  </xs:sequence>
 </xs:complexType>
 <xs:complexType name="DataProfileSettingsType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="DataSourceNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="DataNodeType">
    <xs:sequence>
     <xs:element ref="Attributes"/>
 ...
 <xs:complexType name="DBColumnType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="AttributeType">
 ...
 <xs:complexType name="DecisionTreeAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="DecisionTreeModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ClassificationModelType">
    <xs:sequence>
 ...
 <xs:complexType name="FeatureExtractionBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="BuildNodeType">
    <xs:sequence>
     <xs:element name="Models">
      <xs:complexType>
       <xs:sequence>
        <xs:element name="NonNegativeMatrixFactorModel"
                    type="NonNegativeMatrixFactorModelType"
 ...
 <xs:complexType name="FeatureIdType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="FeatureSetType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column" minOccurs="1">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="FeatureValueType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="FilterDetailsDataNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="FilterDetailsOutputType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="Attributes"/>
  </xs:sequence>
 ...
 <xs:complexType name="GeneralizedLinearAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
...
schema3 := 'xs:attribute name="Status" type="AttributeStatus" use="required"/>
    </xs:complexType>
   </xs:element>
  </xs:sequence>
 </xs:complexType>
 ...
 <xs:complexType name="LinkType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="ConnectorGraphicsInfo"/>
  </xs:sequence>
  <xs:attribute name="Id" type="xs:string" use="required"/>
  ...
  <xs:complexType name="GeneralLinkType" xdb:maintainDOM="false">
    <xs:complexContent>
 ...
 <xs:complexType name="JoinNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
     <xs:choice>
      <xs:element name="SourceNodes" type="JoinSourceNodesType"
                  minOccurs="1"/>
      <xs:element name="KeyColumns" type="JoinKeyColumnsType" minOccurs="1"/>
     </xs:choice>
 ...
 <xs:complexType name="KMeansAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="KMeansModelType" xdb:maintainDOM="false">
  <xs:complexContent>
...
<xs:element name="Attribute" maxOccurs="unbounded" minOccurs="0">
 ...
 <xs:complexType name="MapTargetSourceType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="key" type="UpdateTableColumnType"/>
   <xs:element name="value" type="AttributeType"/>
  </xs:sequence>
 </xs:complexType>
 <xs:complexType name="MapTransformedSource" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="MessageType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:choice>
 ...
 <xs:complexType name="MiningAttributeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="AttributeType">
 ...
 <xs:complexType name="MiningNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="NodeType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="MiningResultType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="ModelDetailsDataNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="ModelDetailsOutputType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Models">
    <xs:complexType xdb:maintainDOM="false">
     <xs:sequence>
 ...
 <xs:complexType name="ModelInfoType" xdb:maintainDOM="false">
  <xs:attribute name="Schema" use="required">
   <xs:simpleType>
    <xs:restriction base="xs:string">
     <xs:minLength value="1"/>
 ...
 <xs:complexType name="ModelNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="MiningNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="ModelSettingODMType" xdb:maintainDOM="false">
  <xs:attribute name="Name" use="required">
   <xs:simpleType>
    <xs:restriction base="xs:string">
     <xs:minLength value="1"/>
 ...
 <xs:complexType name="ModelType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="NaiveBayesAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="NaiveBayesModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ClassificationModelType">
    <xs:sequence>
 ...
 <xs:complexType name="NodeType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="Icon"/>
 ...
 <xs:complexType name="OClusterAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="CLUS_NUM_CLUSTERS" default="10">
    <xs:simpleType>
     <xs:restriction base="xs:integer">
 ...
 <xs:complexType name="OClusterModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ClusteringModelType">
    <xs:sequence>
 ...
 <xs:complexType name="OutputNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="NodeType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="PerformanceType" xdb:maintainDOM="false">
  <xs:choice>
 ...
 <xs:complexType name="PredictionType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="PredictionBoundsType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType>
 ...
 <xs:complexType name="PredictionCostType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="PredictionDetailsType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="PredictionProbabilityType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Column">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="Name" use="required">
 ...
 <xs:complexType name="PredictionSetType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="CostOption">
    <xs:complexType xdb:maintainDOM="false">
     <xs:choice>
 ...
 <xs:complexType name="PriorType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Item" maxOccurs="unbounded" minOccurs="0">
    <xs:complexType xdb:maintainDOM="false">
 ...
 <xs:complexType name="RefModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ModelInfoType">
 ...
 <xs:complexType name="RegressionBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="SuperviseBuildNodeType">
    <xs:sequence>
     <xs:element name="Models">
 ...
 <xs:complexType name="RegressionModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="SuperviseModelType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="RegressionResultType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="MiningResultType">
    <xs:sequence>
 ...
 <xs:complexType name="ResultType" xdb:maintainDOM="false">
  <xs:attribute name="Name" use="required">
   <xs:simpleType>
    <xs:restriction base="xs:string">
     <xs:minLength value="1"/>
 ...
 <xs:complexType name="RGeneralizedLinearAlgoType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="GeneralizedLinearAlgoType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="RGeneralizedLinearModelType" xdb:maintainDOM="false">
  <xs:complexContent>
 ...
 <xs:complexType name="RowFilterNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="RSupportVectorMachineAlgoType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="SupportVectorMachineAlgoType">
    <xs:sequence>
...
schema4 := 'equence>
 ...
 <xs:complexType name="RSupportVectorMachineModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="RegressionModelType">
    <xs:sequence>
 ...
 <xs:complexType name="SampleNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="StringCollection" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Value" maxOccurs="unbounded" minOccurs="0">
    <xs:simpleType>
     <xs:restriction base="xs:string"/>
 ...
 <xs:complexType name="SuperviseBuildNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="BuildNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="SuperviseModelType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ModelType">
    <xs:sequence>
     <xs:element ref="TargetAttribute" minOccurs="0"/>
 ...
 <xs:complexType name="SupplementalAttributesType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element ref="Attribute" maxOccurs="unbounded" minOccurs="0"/>
  </xs:sequence>
  <xs:attribute name="AutoSpec" type="AutoSpecType" use="required"/>
 </xs:complexType>
 <xs:complexType name="SupportVectorMachineAlgoType" xdb:maintainDOM="false">
  <xs:sequence>
 ...
 <xs:complexType name="TableType" xdb:maintainDOM="false">
 ...
 <xs:complexType name="TargetResultType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="ResultType">
    <xs:attribute name="TargetValue" use="required"/>
   </xs:extension>
 ...
 <xs:complexType name="TestDetailsDataNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="TestNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="MiningNodeType">
    <xs:sequence>
     <xs:element ref="TargetAttribute" minOccurs="0"/>
 ...
 <xs:complexType name="TextNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
     <xs:element ref="CaseAttributes"/>
 ...
 <xs:complexType name="TransformsNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="DataNodeType"/>
  </xs:complexContent>
 </xs:complexType>
 <xs:complexType name="TransformationNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformsNodeType">
    <xs:sequence>
     <xs:element ref="TransformationSourceAttributes"/>
 ...
 <xs:complexType name="TransformationOutputAttribute" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="TransformationSourceAttribute">
    <xs:sequence>
 ...
 <xs:complexType name="TransformationSourceAttribute" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="AttributeType">
    <xs:sequence>
 ...
 <xs:complexType name="TransformationType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:choice>
    ...
    <xs:element name="Binning">
     <xs:complexType xdb:maintainDOM="false">
      ...
      <xs:element name="CustomCategorical">
       <xs:complexType xdb:maintainDOM="false">
        <xs:complexContent>
      ...
      <xs:element name="CustomTimestamp">
       <xs:complexType xdb:maintainDOM="false">
        <xs:complexContent>
       ...
       <xs:element name="DateEqualWidth">
        <xs:complexType xdb:maintainDOM="false">
         <xs:complexContent>
           <xs:extension base="CustomDateCutPoints">
             <xs:sequence>
       ...
       <xs:element name="TimestampEqualWidth">
        <xs:complexType xdb:maintainDOM="false">
         <xs:complexContent>
           <xs:extension base="CustomTimestampCutPoints">
             <xs:sequence>
 ...
 <xs:complexType name="TuningType" xdb:maintainDOM="false">
  <xs:choice>
   <xs:element name="None">
     <xs:complexType>
      <xs:complexContent>
 ...
 <xs:complexType name="UpdateTableColumnType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="AttributeType">
 ...
 <xs:complexType name="UpdateTableNodeType" xdb:maintainDOM="false">
  <xs:complexContent>
   <xs:extension base="DataNodeType">
    <xs:sequence>
 ...
 <xs:complexType name="WeightsType" xdb:maintainDOM="false">
  <xs:sequence>
   <xs:element name="Item" maxOccurs="unbounded" minOccurs="0">
    <xs:complexType xdb:maintainDOM="false">
     <xs:attribute name="TargetValue" type="TargetValueStringType"
...
schema5 := 'Type"/>
 ...
 <xs:element name="TimestampTimezoneBin" xdb:defaultTable="">
  ...
  <xs:complexType name="NumericCutPoints" xdb:maintainDOM="false" >
   <xs:sequence>
    <xs:sequence>
  ...
  <xs:complexType name="CategoricalCutPoints"  xdb:maintainDOM="false">
   <xs:sequence>
    <xs:element ref="CategoricalBin" maxOccurs="unbounded" minOccurs="0"/>
   </xs:sequence>
  </xs:complexType>
  
  <xs:complexType name="CustomDateCutPoints"  xdb:maintainDOM="false">
   <xs:sequence>
    <xs:sequence>
  ...
  <xs:complexType name="CustomTimestampCutPoints" xdb:maintainDOM="false">
   <xs:sequence>
    <xs:sequence>
  ...
  <xs:complexType name="OutlierBound" xdb:maintainDOM="false">
   <xs:attribute name="LowerValue" default="0">
    <xs:simpleType>
     <xs:restriction base="xs:double"/>
    </xs:simpleType>
  ...
  <xs:complexType name="NormalizationValues" xdb:maintainDOM="false">
 ...
 <!-- Transformation End -->
  ...
  DBMS_XMLSCHEMA.registerSchema(
    ...
    schemadoc => schema1||schema2||schema3||schema4||schema5,
    local => FALSE,
    gentypes => TRUE,
    genbean => FALSE,
    gentables => TRUE,
