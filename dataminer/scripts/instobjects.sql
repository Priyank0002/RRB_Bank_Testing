...
INSERT INTO ODMRSYS.ODMR$REPOSITORY_PROPERTIES (PROPERTY_NAME, PROPERTY_STR_VALUE, "COMMENT") VALUES ('VERSION', '11.2.0.1.10', 'Version of the Repository');
...
(
  ...
  s as (select
          ...
          CASE WHEN (INSTR(additional_info, ', ', 1, 2)) > 0
               THEN SUBSTR(additional_info, (INSTR(additional_info, ', ', 1, 2))+LENGTH(', '), LENGTH(additional_info) - (INSTR(additional_info, ', ', 1, 2)))
               ELSE NULL
          END "LOG_MESSAGE"
