...
2. Copy all *.xslt files from current directory in OS directory mapped as oracle directory OSDDM_REPORTS_DIR
...
6. Results will be shown in Scripts Output window
   ...
   Note: Oracle directory OSDDM_REPORTS_DIR is directory where the reports will be generated, so it has to be existing OS directory on Oracle server with OS read / write permissions.